    ...
    return <Link href={"/user-settings"} className={"flex flex-col items-center"}>
        <DropdownMenu.Root modal={false}>
            <DropdownMenu.Trigger>
                <Avatar.Root
                    className={"shadow-sm shadow-black bg-amber-400 inline-flex h-[100px] w-[100px] select-none items-center justify-center overflow-hidden rounded-full align-middle border-4 border-white"}>
                    <Avatar.Image
