...
export function TodoCloseView({ todo, setOpenCloseView }: ToDo) {
    ...
    return (
        <div className="border border-white/10 p-6 backdrop-blur-2xl bg-black/40 rounded-xl focus:outline-none">
            <div className="flex items-center justify-between mb-4">
                            ...
                            <Tooltip.Root>
                                ...
                                <Tooltip.Portal>
                                    <Tooltip.Content
                                        ...
                                        sideOffset={5}
                                    >
                                        <span className="text-green-800 font-semibold">{t("public")}</span>
                                    </Tooltip.Content>
                                </Tooltip.Portal>
                            </Tooltip.Root>
                        </Tooltip.Provider> :
                            ...
                            <Tooltip.Root>
                                ...
                                <Tooltip.Portal>
                                    <Tooltip.Content
                                        ...
                                        sideOffset={5}
                                    >
                                        <span className="text-red-700 font-semibold">{t("private")}</span>
                                    </Tooltip.Content>
                                </Tooltip.Portal>
                            </Tooltip.Root>
                        </Tooltip.Provider>
                ...
                <div className={"flex items-center gap-2"}>
                    <span className={"text-gray-300"}>{t("priority.label")}:</span>
                    <div className={`rounded-full text-xs py-1 px-2 ${priorityColors[todo.priority]} text-white`}>
                        {
                            todo.priority === "low" ? t("priority.low") : todo.priority === "medium" ? t("priority.medium") : t("priority.high")
                        }
                    </div>
                </div>
            </div>
